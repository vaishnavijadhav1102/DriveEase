...
<body>
        ...
        <div class="swiper swipper-c">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="images/carousel/p1.jpg" class = "w-100 d-block"/>
                </div>
                <div class="swiper-slide">
                    <img src="images/carousel/p2.jpg" class = "w-100 d-block"/>
                </div>
                <div class="swiper-slide">
                    <img src="images/carousel/p3.jpg" class = "w-100 d-block"/>
                </div>
                <div class="swiper-slide">
                    <img src="images/carousel/p5.jpg" class = "w-100 d-block"/>
                </div>
                <div class="swiper-slide">
                    <img src="images/carousel/p6.jpg" class = "w-100 d-block"/>
                </div>
                    ...
                    <div class="row align-items-end" style="position: relative;left:15%;">
                        ...
                        <div class="col-lg-4">
                            <button style="left:50px;position:relative" type="submit" class="btn text-dark">
                                <a href=""></a>Check Availability</button>
                        </div>
                    </div>
                </form>
                <br>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 mx-auto mt-4">
                        <div class="card" style="width: 18rem;">
                            <img src="images/about/aboutus_vaishi.png">
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 mx-auto mt-4">
                        <div class="card" style="width: 18rem;">
                            <img src="images/about/aboutus_mahak.png">
                            <div class="card-body">
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-2">
                <img src="images/facilities/parking.gif" width="200px" height="200px">
            </div>
            <div class="col-lg-2">
                <img src="images/facilities/car-service.gif" width="200px" height="200px">
            </div>
            <div class="col-lg-2">
                <img src="images/facilities/eco-fuel.gif" width="200px" height="200px">
            </div>
            <div class="col-lg-2">
                <img src="images/facilities/map.gif" width="200px" height="200px">
            </div>
        </div>
    </div>
